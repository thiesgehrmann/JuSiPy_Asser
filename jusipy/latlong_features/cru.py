...
class CRU(object):
    def __init__(self):
        ...
        pre =  np.load(open('jusipy/latlong_features/data/weather_data/pre.npy', 'rb'))
        cld =  np.load(open('jusipy/latlong_features/data/weather_data/cld.npy', 'rb')) 
        tmp =  np.load(open('jusipy/latlong_features/data/weather_data/tmp.npy', 'rb'))
        pet =  np.load(open('jusipy/latlong_features/data/weather_data/pet.npy', 'rb'))
    ...
    def lookup_single(self, feature, lat, long, pixel_window=0):
        ...
        '''
        v = latlong_lookup(self._data[feature], lat, long, pixel_window)
